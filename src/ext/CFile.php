...
class CFile
{
     ...
     * @return CFile the instance of the uploaded file.
     ...
     * @return CFile[] the array of CUploadedFile objects. Empty array is returned
    ...
    /**
     * Cleans up the loaded CFile instances.
    ...
    protected static function collectFilesRecursive($key, $names, $tmp_names, $types, $sizes, $errors)
    {
        if (is_array($names)) {
            ...
            self::$_files[$key] = new CFile($names, $tmp_names, $types, $sizes, $errors);
    }
