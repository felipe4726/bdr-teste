...
class ImageConverter
{
    ...
    public static function TransformToJpeg($sourceFile, $targetFile)
    {
        ...
        if (\Bdr\Sistema::app()->imageMacickPath) {
            $convertCommand = \Bdr\Sistema::app()->imageMacickPath;
    ...
    public static function Resize($sourceFile, $targetFile, $options = array())
    {
        ...
        if (!isset($options['transparent']))
            $options['transparent'] = true;  // setando como padr�o fazer resize com transparencia
